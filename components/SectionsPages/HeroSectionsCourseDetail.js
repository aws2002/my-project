...
export default function HeroSectionsCourseDetail() {
  return (
    <section className="hero-sections-course-detail mb-5 bg-color_22 py-36 px-4">
      <div className=" container">
        <div className=" grid grid-cols-12">
          <motion.div
            ...
            layout
            className="md:col-span-8 col-span-full my-auto"
          >
              ...
              {[
                {
                  ...
                  title: "4.5/5.0",
                  icon: (
                    <FaStar className=" inline text-color_11 text-xl -mt-1" />
                  ),
                },
                {
                  id: 2,
                  title: "12k Enrolled",
                  icon: (
                    <FaUserGraduate className="inline text-color_5 text-xl -mt-1" />
                  ),
                },
                {
                  id: 3,
                  title: "All levels",
                  icon: (
                    <FaSignal className="inline text-color_9 text-xl -mt-1" />
                  ),
                },
                {
                  id: 4,
                  title: "Last updated 09/2021",
                  icon: (
                    <BsExclamationOctagonFill className="inline text-color_10 text-xl -mt-1" />
                  ),
                },
                {
                  id: 5,
                  title: "English",
                  icon: (
                    <BsGlobe2 className="inline text-color_9 text-xl -mt-1" />
                  ),
                },
              ].map((item) => (
                <li
                  key={item.id}
                  className=" mr-5 mb-2 inline-block font-medium icon"
                >
