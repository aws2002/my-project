      ...
      <section className="hero--sections my-10 relative">
        ...
        <div className="container grid grid-cols-12 gap-7">
            ...
            <ul className=" mb-7">
              {[
                ...
                <li key={item.id} className=" inline-block mr-2">
                  ...
                  <span className=" text-color_1 font-medium">
                    {item.titel}
                  </span>
                </li>
              ))}
          ...
          <motion.div
            ...
            transition={{ duration: 0.5 }}
            layout
            className="md:col-span-6 col-span-full contantImge bg-color_5  md:ml-auto md:mt-0 md:w-[90%] mt-10 relative "
          >
            <div className="absolute w-16 h-16 left-28 top-16 md:flex justify-center">
            ...
            <div className=" bg-white  hidden absolute rounded-xl shadow-lg w-16 h-16 -left-20 top-32 p-2 md:flex justify-center">
              <img src="./asset 12.svg" alt="" />
            </div>
            <div className=" w-48 h-28 rounded-xl right-0 top-24 md:block hidden absolute p-4 bg-img-4 bg-color_9">
              <p className=" text-white text-sm text-center font-semibold">
                Our daily new students
              </p>
              <div className="flex -space-x-1 overflow-hidden py-3 justify-center items-center mt-2">
                {[
                  {
                    id: 1,
