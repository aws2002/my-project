  ...
  return (
    ...
    <section className="sign-in">
      <div className=" grid grid-cols-2">
        ...
        <div className=" md:col-span-1 col-span-full md:px-32 px-12 md:py-10">
          ...
          {[
            ...
            },
            {
              ...
              subText: "Your password must be 8 characters at least",
            },
          ].map((item) => (
            <div key={item.id}>
              <label
              ...
              <div className="relative">
                ...
                />
                <p className=" mt-1 text-color_1 font-medium">{item.subText}</p>
              </div>
            </div>
          ))}
          ...
          <div className=" grid grid-cols-12 mt-3 gap-x-4">
            ...
            <div className="col-span-6">
              ...
              >
                <FaFacebookF className=" inline text-xl" /> Login with Facebook
              </a>
            </div>
